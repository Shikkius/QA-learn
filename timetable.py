#Вам надо написать программу, которая принимает на вход дату, которую вводит пользователь,
#а отдает расписание учебы на следующие тридцать дней после этой даты.
# Расписание должно включать в себя дату в обычной для нас записи (день.месяц.год) и название дня недели.
